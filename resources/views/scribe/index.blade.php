                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-GETapi-settings">GET api/settings</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-settings--id-">
                                <a href="#endpoints-PUTapi-settings--id-">PUT api/settings/{id}</a>
                            </li>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-PUTapi-settings--id-">PUT api/settings/{id}</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request PUT \
    "http://localhost/api/settings/architecto" \
    --header "Content-Type: multipart/form-data" \
    --header "Accept: application/json" \
    --form "name=architecto"\
    --form "facebook=http://bailey.com/"\
    --form "youtube=http://rempel.com/sunt-nihil-accusantium-harum-mollitia"\
    --form "instagram=http://www.considine.com/provident-perspiciatis-quo-omnis-nostrum-aut-adipisci-quidem"\
    --form "email=dare.emelie@example.com"\
    --form "phone=architecto"\
    --form "second_phone=architecto"\
    --form "logo=@C:\Users\MF\AppData\Local\Temp\php1BE3.tmp" </code></pre></div>
...
body.append('youtube', 'http://rempel.com/sunt-nihil-accusantium-harum-mollitia');
body.append('instagram', 'http://www.considine.com/provident-perspiciatis-quo-omnis-nostrum-aut-adipisci-quidem');
body.append('email', 'dare.emelie@example.com');
body.append('phone', 'architecto');
body.append('second_phone', 'architecto');
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="id"                data-endpoint="PUTapi-settings--id-"
               value="architecto"
               data-component="url">
    <br>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="name.ar"                data-endpoint="PUTapi-settings--id-"
               value="architecto"
               data-component="body">
    <br>
<p>Example: <code>architecto</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="name.en"                data-endpoint="PUTapi-settings--id-"
               value="architecto"
               data-component="body">
    <br>
<p>Example: <code>architecto</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="facebook"                data-endpoint="PUTapi-settings--id-"
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="youtube"                data-endpoint="PUTapi-settings--id-"
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="instagram"                data-endpoint="PUTapi-settings--id-"
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="meta"                data-endpoint="PUTapi-settings--id-"
               value=""
               data-component="body">
    <br>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="email"                data-endpoint="PUTapi-settings--id-"
               value="dare.emelie@example.com"
               data-component="body">
    <br>
<p>Must be a valid email address. Example: <code>dare.emelie@example.com</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>phone</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="phone"                data-endpoint="PUTapi-settings--id-"
               value="architecto"
               data-component="body">
    <br>
<p>Example: <code>architecto</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="second_phone"                data-endpoint="PUTapi-settings--id-"
               value="architecto"
               data-component="body">
    <br>
<p>Example: <code>architecto</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="file" style="display: none"
                              name="logo"                data-endpoint="PUTapi-settings--id-"
               value=""
               data-component="body">
    <br>
<p>Must be an image. Example: <code>C:\Users\MF\AppData\Local\Temp\php1BE3.tmp</code></p>
        </div>
        </form>
...
<div class="bash-example">
    ...
    --header "Accept: application/json" \
    --form "name=architecto"\
    --form "description=http://bailey.com/"\
    --form "testimonial=http://rempel.com/sunt-nihil-accusantium-harum-mollitia"\
    --form "logo=@C:\Users\MF\AppData\Local\Temp\php1C51.tmp" </code></pre></div>
...
const body = new FormData();
body.append('name', 'architecto');
body.append('description', 'http://bailey.com/');
body.append('testimonial', 'http://rempel.com/sunt-nihil-accusantium-harum-mollitia');
body.append('logo', document.querySelector('input[name="logo"]').files[0]);
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="name.ar"                data-endpoint="POSTapi-clients"
               value="architecto"
               data-component="body">
    <br>
<p>Example: <code>architecto</code></p>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="name.en"                data-endpoint="POSTapi-clients"
               value="architecto"
               data-component="body">
    <br>
<p>Example: <code>architecto</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be an image. Example: <code>C:\Users\MF\AppData\Local\Temp\php1C51.tmp</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>meta</code></b>&nbsp;&nbsp;
<small>object</small>&nbsp;
...
<div class="bash-example">
    ...
    --form "description=http://bailey.com/"\
    --form "testimonial=http://rempel.com/sunt-nihil-accusantium-harum-mollitia"\
    --form "logo=@C:\Users\MF\AppData\Local\Temp\php1CA0.tmp" </code></pre></div>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="name.ar"                data-endpoint="PUTapi-clients--id-"
               value="architecto"
               data-component="body">
    <br>
<p>Example: <code>architecto</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="name.en"                data-endpoint="PUTapi-clients--id-"
               value="architecto"
               data-component="body">
    <br>
<p>Example: <code>architecto</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>Must be an image. Must not be greater than 2048 kilobytes. Example: <code>C:\Users\MF\AppData\Local\Temp\php1CA0.tmp</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>meta</code></b>&nbsp;&nbsp;
<small>object</small>&nbsp;
